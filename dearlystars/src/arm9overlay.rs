...
//*********************************************************************************************
fn apply_translation(mut file: &File, csv_data: &Vec<Vec<String>>, row: usize, blanks: &String) -> Result<()> {
...
pub fn arm9overlay(in_dir: &PathBuf, in_csv_dir: &PathBuf) -> Result<()> {
    ...
    while row < 166 {      //loop for Overlay9 0002
    ...
    while row < 279 {      //loop for Overlay9 0003
    ...
    while row < 321 {      //loop for Overlay9 0004
    ...
    while row < 349 {      //loop for Overlay9 0005
    ...
    while row < 359 {      //loop for Overlay9 0008
    ...
    while row < 394 {      //loop for Overlay9 0009
